...
<div class="main">
    ...
    <div class="page_me justify-content-center">
        <?php
        $stmt = $pdo->prepare("select * from `tarif_par_produit_colis` where `id`=:id");
        $stmt->execute(['id'=>$_GET['id']]);
        $row = $stmt->fetch(PDO::FETCH_ASSOC);
        ?>
        <form style="margin-left: 250px" class="p-4 form-control h-50 align-self-center bg-dark text-light d-flex flex-column" method="post" action="../controllers/tarifControl_colis.php">
